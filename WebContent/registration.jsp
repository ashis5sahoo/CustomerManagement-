...
<html>
	...
	<style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        section aside { width: 40%; background-color: #3b3b3b; padding: 1.5%; border-radius: 3px; box-shadow: 0 5px 8px 0 #00000080; }
        ...
        input[type=submit],[type=button]  { margin: 10% 0 0 10%; font-weight: 500; width: 30%; font-weight: bold; border: none; color: #0c0c0c; background-color: #cfcfcf; padding: 8px; font-size: 18px; border-radius: 3px; cursor: pointer; }
        ...
        #select-container { height: 40px; position: relative; width: calc(100% - 20px); font-size: 15px; font-weight: bold; }
        #dropdown { border: 1px solid #afafaf; border-radius: 3px; background-color: #bbb9b9; color: #1f1f1f; cursor: pointer; height: 100%; outline: none; padding: 8px 10px; width: 100%; margin: 3px 0 3px 6px; }
        #dropdown option {background: #afafaf; color: #1f1f1f; }
